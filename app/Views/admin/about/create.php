...
<?= $this->section('title'); ?><?= lang('Sidemin.add_item'); ?><?= $this->endSection(); ?>
...
<div class="page-header">
    <div>
        <h2 class="page-title"><?= lang('Sidemin.add_item'); ?></h2>
    </div>
</div>
...
<div class="card">
    ...
    <form action="<?= base_url('admin/about/saveItem'); ?>" method="post" enctype="multipart/form-data">
        
        <div class="form-group" style="margin-bottom: 24px;">
            <label class="form-label"><?= lang('Sidemin.table_image'); ?> (Maks 10MB)</label>
            <input type="file" name="image" class="form-control" accept="image/*" onchange="previewImage(this, 'new_image_preview')" required>
            <div class="image-preview-wrapper" id="new_image_preview_wrapper" style="display: none; margin-top: 10px;">
                <img id="new_image_preview" src="" alt="Preview" style="max-width: 200px; border-radius: 8px; border: 1px solid #e2e8f0;">
            </div>
        </div>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <input type="text" id="item_title_id" name="title_id" class="form-control" required>
            </div>
            <div class="form-group">
                <div class="label-wrapper"><label class="form-label"><?= lang('Sidemin.table_title'); ?> (English)</label></div>
                <input type="text" id="item_title_en" name="title_en" class="form-control">
            </div>
            <div class="form-group">
                <div class="label-wrapper"><label class="form-label"><?= lang('Sidemin.table_title'); ?> (Italiano)</label></div>
                <input type="text" id="item_title_it" name="title_it" class="form-control">
            </div>
        </div>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <textarea id="item_desc_id" name="desc_id" class="form-control" rows="5" required></textarea>
            </div>
            <div class="form-group">
                <div class="label-wrapper"><label class="form-label"><?= lang('Sidemin.table_desc'); ?> (English)</label></div>
                <textarea id="item_desc_en" name="desc_en" class="form-control" rows="5"></textarea>
            </div>
            <div class="form-group">
                <div class="label-wrapper"><label class="form-label"><?= lang('Sidemin.table_desc'); ?> (Italiano)</label></div>
                <textarea id="item_desc_it" name="desc_it" class="form-control" rows="5"></textarea>
            </div>
        </div>

        <div style="margin-top: 24px; display: flex; gap: 12px;">
            <button type="submit" class="btn btn-primary"><?= lang('Sidemin.save_item'); ?></button>
...
<script>
    // Fungsi untuk nampilin preview gambar pas di-upload
    ...
    // Fungsi Auto Translate biar gak usah copas-copas ke google translate
